...
//	}
	...
	private Bitmap drawSpaceBar( int opacity, boolean isAutoCompletion )
	{
		...
		if( mLocale!=null )
		{
			...
			final String language=layoutSpaceBar( paint, locale, mButtonArrowLeftIcon, mButtonArrowRightIcon, width, height, getTextSizeFromTheme( android.R.style.TextAppearance_Small, 14 ), allowVariableTextSize );
